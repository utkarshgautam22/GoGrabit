...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-d12k1q7$+)(lanci1a7oq9)v&as_8mu8p42dtf=bxa&e3p+_p)')
...
# CSRF settings
csrf_origins = os.environ.get('CSRF_TRUSTED_ORIGINS', 'http://localhost:8000,http://127.0.0.1:8000').strip()
